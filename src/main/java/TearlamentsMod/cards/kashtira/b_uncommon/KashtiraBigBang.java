...
public class KashtiraBigBang extends BaseCard {
    public static final String ID = makeID(KashtiraBigBang.class.getSimpleName());
    ...
    public void triggerOnOtherCardPlayed(AbstractCard c) {
        addToBot(new ExhumeAction(this.upgraded));
