...
public class MannadiumFearless extends EvolvingCard {
    public static final String ID = makeID(MannadiumFearless.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ChannelAction(new FearlessOrb(false)));
    }
