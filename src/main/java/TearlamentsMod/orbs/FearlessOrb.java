...
public class FearlessOrb extends CustomOrb {

    public static final String ORB_ID = VisasMod.makeID(FearlessOrb.class.getSimpleName());
    ...
    public FearlessOrb(String ID, String NAME, int basePassiveAmount, int baseEvokeAmount, String passiveDescription, String evokeDescription) {
        super(ID, NAME, basePassiveAmount, baseEvokeAmount, passiveDescription, evokeDescription);
    }

    public FearlessOrb(String ID, String NAME, int basePassiveAmount, int baseEvokeAmount, String passiveDescription, String evokeDescription, String imgPath) {
    ...
    public FearlessOrb(boolean upgraded) {
        this();
    ...
    @Override
    public void onEvoke() {
        AbstractCard c = new MannadiumFearless();
    ...
    public AbstractOrb makeCopy() {
        return new FearlessOrb(this.ID, this.name, this.basePassiveAmount, this.baseEvokeAmount, this.passiveDescription, this.evokeDescription);
    }
