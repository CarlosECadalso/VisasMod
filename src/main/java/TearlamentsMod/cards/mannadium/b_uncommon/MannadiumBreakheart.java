...
public class MannadiumBreakheart extends BaseCard {
    public static final String ID = makeID(MannadiumBreakheart.class.getSimpleName());
    ...
    public boolean canUse(AbstractPlayer p, AbstractMonster m) {
        return super.canUse(p, m) && p.hasOrb();
    }
