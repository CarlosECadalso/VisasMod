...
import TearlamentsMod.cards.generic.d_starter.StrikeVisas;
import TearlamentsMod.relics.StarfrostRelic;
...
import static TearlamentsMod.VisasMod.characterPath;
import static TearlamentsMod.VisasMod.makeID;

public class Visas extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Visas"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass VISAS;
        @SpireEnum(name = "VISAS_BLUE_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "VISAS_BLUE_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;

        //Character select images
        private static final String CHAR_SELECT_BUTTON = characterPath("select/VisasButton.png");
        private static final String CHAR_SELECT_PORTRAIT = characterPath("select/VisasPortrait.png");

        //Character card images
        private static final String BG_ATTACK = characterPath("cardback/bg_attack_visas.png");
        private static final String BG_ATTACK_P = characterPath("cardback/bg_attack_p_visas.png");
        private static final String BG_SKILL = characterPath("cardback/bg_skill_visas.png");
        private static final String BG_SKILL_P = characterPath("cardback/bg_skill_p_visas.png");
        private static final String BG_POWER = characterPath("cardback/bg_power_visas.png");
        private static final String BG_POWER_P = characterPath("cardback/bg_power_p_visas.png");
        ...
        private static final Color cardColor = new Color(25f/255f, 25f/255f, 112f/255f, 1f);
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Visas(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public Visas() {
        super(getNames()[0], Meta.VISAS,
                new CustomEnergyOrb(orbTextures, characterPath("energyorb/vfx.png"), layerSpeeds), //Energy Orb
                new SpineAnimation(characterPath("Visas/Visas.atlas"), characterPath("Visas/Visas.json"), 2.5f)); //Animation
        ...
        initializeClass(null,
                ...
                CORPSE,
                getLoadout(),
                30.0F, -20.0F, 200.0F, 250.0F, //Character hitbox. x y position, then width and height.
...
//        retVal.add(TearlamentKashtira.ID);
...
//        retVal.add(TearlamentKitkallos.ID);
        ...
        retVal.add(StrikeVisas.ID);
        retVal.add(StrikeVisas.ID);
        retVal.add(DefendVisas.ID);
        retVal.add(DefendVisas.ID);
        retVal.add(DefendVisas.ID);
        retVal.add(DefendVisas.ID);
        retVal.add(ClearNewWorld.ID);
        return retVal;
    }
