...
public class ScareclawTwinsaw extends BaseCard {
    public static final String ID = makeID(ScareclawTwinsaw.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.setDamage(AbstractDungeon.actionManager.cardsPlayedThisTurn.size(), 0);
