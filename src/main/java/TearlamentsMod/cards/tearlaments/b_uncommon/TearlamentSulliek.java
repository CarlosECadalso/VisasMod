...
import TearlamentsMod.powers.TearlamentSulliekPower;
...
public class TearlamentSulliek extends BaseCard {
    public static final String ID = makeID(TearlamentSulliek.class.getSimpleName());
    ...
    private static final int MAGIC_NUMBER = TearlamentSulliekPower.MAGIC_NUMBER;
    private static final int UPG_MAGIC_NUMBER = TearlamentSulliekPower.MAGIC_NUMBER;

    public TearlamentSulliek() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new TearlamentSulliekPower(p, 1)));
    }
