package TearlamentsMod.cards.tearlaments.a_common;
...
public class TearlamentMetanoise extends BaseCard {
    public static final String ID = makeID(TearlamentMetanoise.class.getSimpleName());
